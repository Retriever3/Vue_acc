 ...
 * @returns {*}
 */
function searchAccountSubjectList(){
    return accountApi.get('/base/parentAccountList')
}

function searchAccountDetailList(payload){
    console.log('searchAccountDetailList',payload)
    return accountApi.get('/base/account/findDetailAccountList',
        {params: {code: payload}})
}

export {
    fetchAccountCode, fetchAccountCustomerCode, fetchAccountControllCode, fetchAccountLedger, fetchGeneralAccountLedger, fetchAccountCodeList, deleteAccountCode, addAccountCode, searchCustomerInfoList, deleteCustomerCode,saveCustomer,searchAccountSubjectList,searchAccountDetailList,
}
